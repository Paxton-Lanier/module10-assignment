...
# fill missing phone numbers with placeholder format
df_no_missing["phone"] = df_no_missing["phone"].fillna("0000000000")

# fill missing loyalty status with Bronze since that's the lowest tier
df_no_missing["loyalty_status"] = df_no_missing["loyalty_status"].fillna("Bronze")

# fill missing age with median age
age_median = int(df_no_missing["age"].median())
...
data_type_issues = [
    ...
    "Inconsistent numeric formatting in phone numbers",
    "Missing numeric values in satisfaction_rating and age"
]
